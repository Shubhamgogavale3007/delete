enum Level { verbose, debug, info, warning, error, nothing, notification }
...
class Logger {
  ...
  /// Log message at level [Level.notification].
  void n(dynamic message, [dynamic error, StackTrace? stackTrace]) {
    log(Level.notification, message, error, stackTrace);
  }
  ...
  static int _getLevelToInt(Level level) {
    if (level == Level.verbose) {
      ...
      return 6;
    } else if (level == Level.notification) {
      return 7;
    }
    return -1;
  }
